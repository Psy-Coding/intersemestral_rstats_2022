...
![Meme](https://i.chzbgr.com/full/1665317632/hDA2412AB/stoopid-humin-correlation-does-not-imply-causation)
...
```{r}
BD_ABIDE<-read.csv("./img/Phenotypic_V1_0b.csv")
```
...
library(dplyr)
BD<-BD_ABIDE %>% select(SITE_ID,DX_GROUP,SRS_RAW_TOTAL,VIQ,AGE_AT_SCAN) %>% filter(SITE_ID=="YALE",SRS_RAW_TOTAL!=-9999) #Se eliminan valores NA codificados como -9999 en esta base de datos
```
