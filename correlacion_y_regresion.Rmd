...
Una diferencia **estadísticamente significativa** solamente significa que existe evidencia estadística de que hay una relación. NO significa que la relación sea grande, importante o radicalmente diferente; para conocer la magnitud de la correlación recurrimos al coeficiente (cor).
...
Da click [aquí para leer](http://scielo.sld.cu/scielo.php?script=sci_arttext&pid=S1729-519X2009000200017) sobre la correlación de Spearman y la clasificación por rangos o [aquí para ver un tutorial.](https://www.youtube.com/watch?v=jscoRayse7I)
...
* Pendiente (predictor VIQ): Por cada unidad que se incrementa en el predictor VIQ, el puntaje de la SRS disminuye en promedio 0.4741 unidades.
